...
module SatTKEx = struct
  ...
  let ex_test_compile_case_unit : tk_prgm = [
    { name = "maino";
      args = [Sum (bool_adt, Prod (bool_adt, bool_adt))];
      body =
        Fresh (bool_adt,
        Lefto ((1, Sum (bool_adt, Sum (bool_adt, bool_adt))), (0, bool_adt))) }]

  let ex_test_compile_case_bool : tk_prgm = [
    { name = "maino";
      args = [Sum (bool_adt, Prod (bool_adt, bool_adt))];
      body =
        Fresh (bool_adt,
        Lefto ((1, Sum (bool_adt, Prod (bool_adt, bool_adt))), (0, bool_adt))) }]

  let ex_test_compile_case_prod : tk_prgm = [
    { name = "maino";
      args = [Sum (Prod (bool_adt, bool_adt), Prod (bool_adt, Prod (bool_adt, bool_adt)))];
      body =
        Fresh (Prod (bool_adt, bool_adt),
        Lefto (
          (1, Sum (Prod (bool_adt, bool_adt), Prod (bool_adt, Prod (bool_adt, bool_adt)))),
          (0, Prod (bool_adt, bool_adt)))) }]
